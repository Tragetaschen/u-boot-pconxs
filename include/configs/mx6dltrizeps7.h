#ifndef __MX6DLTRIZEPS7_CONFIG_H
#define  __MX6DLTRIZEPS7CONFIG_H
...
/* Ethernet */
#define CONFIG_TARGET_NATIVE_PHY_ACTIVE 0
#define CONFIG_TARGET_REVERSE_MAC_ADDRESS
